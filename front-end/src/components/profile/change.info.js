...
export default function ChangeInfo() {
    ...
    const handeChangeInfo = async (e) => {
        ...
        if (!state.email || !state.username || !state.dateOfBirth || !state.phoneNumber) {
            setState((previousState) => {
        ...
        <div className="col-md-3 col-sm-6 col-xs-12 change-form">
            ...
            <form onSubmit={handeChangeInfo}>
                ...
                <div className="form-group row my-4">
                    ...
                    <div className="col-sm-10">
                        <input type="date" className="form-control text-center" id="date-of-birth" value={state.dateOfBirth}
                ...
                <div className="form-group row my-4">
                    ...
                    <div className="col-sm-10">
                        <input type="tel" className="form-control" id="phone-number" value={state.phoneNumber}
